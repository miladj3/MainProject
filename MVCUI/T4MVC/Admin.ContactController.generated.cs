...
namespace MVCUI.Areas.Admin.Controllers
{
    public partial class ContactController
    {
        ...
        static readonly ActionParamsClass__list s_params__list = new ActionParamsClass__list();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass__list _listParams { get { return s_params__list; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass__list
        {
            public readonly string isSeen = "isSeen";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _list = "~/Areas/Admin/Views/Contact/_list.cshtml";
            public readonly string Index = "~/Areas/Admin/Views/Contact/Index.cshtml";
            public readonly string Show = "~/Areas/Admin/Views/Contact/Show.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ContactController : MVCUI.Areas.Admin.Controllers.ContactController
    {
        ...
        [NonAction]
        partial void _listOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo, bool isSeen, DomainClasses.Enums.ContactType type, int page, int count);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult _list(bool isSeen, DomainClasses.Enums.ContactType type, int page, int count)
        {
            var callInfo = new T4MVC_System_Web_Mvc_PartialViewResult(Area, Name, ActionNames._list);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "isSeen", isSeen);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "type", type);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "page", page);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "count", count);
            _listOverride(callInfo, isSeen, type, page, count);
            return callInfo;
        }

        [NonAction]
        partial void ShowOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long? id);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Show(long? id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Show);
