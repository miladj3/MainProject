...
namespace MVCUI.Controllers
{
    public partial class BlogController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> blog()
        {
        ...
        public class ViewsClass
        {
            ...
            public readonly string blog = "~/Views/Blog/blog.cshtml";
            public readonly string Index = "~/Views/Blog/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BlogController : MVCUI.Controllers.BlogController
    {
        ...
        [NonAction]
        partial void blogOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, string title);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> blog(long id, string title)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.blog);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "title", title);
            blogOverride(callInfo, id, title);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.ActionResult);
        }
