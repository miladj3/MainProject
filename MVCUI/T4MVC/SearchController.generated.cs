...
namespace MVCUI.Controllers
{
    public partial class SearchController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _AutoComplete = "_AutoComplete";
                public readonly string Index = "Index";
                public readonly string Search = "Search";
            }
            public readonly string _AutoComplete = "~/Views/Search/_AutoComplete.cshtml";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SearchController : MVCUI.Controllers.SearchController
    {
        ...
        [NonAction]
        partial void SearchOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string word);

        [NonAction]
        public override System.Web.Mvc.ActionResult Search(string word)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Search);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "word", word);
            SearchOverride(callInfo, word);
            return callInfo;
        }
